...
int otto(Kortti* kortti){
    int valinta, valinta2, ottoSumma = 0, voiNostaa;
    ...
    switch (valinta) {
        ...
        case 7:{
            printf("\nPaljonko haluat nostaa (max 400 euroa) \n");
            do {
                voiNostaa = 1;
                printf(" > ");
                scanf("%i", &ottoSumma);
                fflush(stdin);
                if (ottoSumma > 400){
                    puts("Et voi nostaa yli 400 euroa tasta automaatista \n");
                    voiNostaa = 0;
                }
                else if (ottoSumma % 10 != 0){
                    puts("Pienin seteli automaatissa on 10 euroa \n");
                    voiNostaa = 0;
                }
